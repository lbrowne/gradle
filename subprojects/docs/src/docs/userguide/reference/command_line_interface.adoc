...
include::{snippetsPath}/userguide/tutorial/excludeTasks/excludeTask.out[]
----
...
----
$ gradle cT
include::{snippetsPath}/userguide/tutorial/excludeTasks/abbreviateCamelCaseTaskName.out[]
----
...
include::{snippetsPath}/userguide/tutorial/projectReports/taskHelp.out[]
----
...
include::{snippetsPath}/userguide/tutorial/projectReports/propertyListReport.out[]
----
