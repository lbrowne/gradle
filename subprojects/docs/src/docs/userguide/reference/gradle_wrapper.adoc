...
----
$ gradle wrapper
include::{snippetsPath}/userguide/wrapper/simple/wrapperCommandLine.out[]
----
...
----
$ gradlew.bat build
include::{snippetsPath}/userguide/wrapper/wrapperBatchFileExecution.out[]
----
...
include::{snippetsPath}/userguide/wrapper/wrapperGradleVersionUpgrade.out[]
----
