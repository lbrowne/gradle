...
.build.gradle
----
include::{snippetsPath}/userguide/modelRules/configureAsRequired/build.gradle[tag=configure-rule]
----

.Output of **`gradle showPerson`**
----
> gradle showPerson
include::{snippetsPath}/userguide/modelRules/configureAsRequired/modelDslConfigureRuleRunWhenRequired.out[]
----
...
include::{snippetsPath}/userguide/modelRules/configureAsRequired/modelDslConfigureRuleNotRunWhenNotRequired.out[]
----
...
.build.gradle
----
include::{snippetsPath}/userguide/modelRules/initializationRuleRunsBeforeConfigurationRules/build.gradle[tag=configure-and-create-rules]
----

.Output of **`gradle showPerson`**
----
> gradle showPerson
include::{snippetsPath}/userguide/modelRules/initializationRuleRunsBeforeConfigurationRules/modelDslInitializationRuleRunsBeforeConfigurationRule.out[]
----
...
.build.gradle
----
include::{snippetsPath}/userguide/modelRules/configureElementsOfMap/build.gradle[tag=create-and-configure]
----

.Output of **`gradle listPeople`**
----
> gradle listPeople
include::{snippetsPath}/userguide/modelRules/configureElementsOfMap/modelDslModelMapNestedAll.out[]
----
