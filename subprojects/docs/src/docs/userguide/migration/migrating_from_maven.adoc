...
====
include::sample[dir="snippets/userguide/mavenMigration/basic/groovy",files="build.gradle[tags=compile-dependencies]"]
include::sample[dir="snippets/userguide/mavenMigration/basic/kotlin",files="build.gradle.kts[tags=compile-dependencies]"]
====
...
====
include::sample[dir="snippets/userguide/mavenMigration/basic/groovy",files="build.gradle[tags=pom-dependencies]"]
include::sample[dir="snippets/userguide/mavenMigration/basic/kotlin",files="build.gradle.kts[tags=pom-dependencies]"]
====
+
...
====
include::sample[dir="snippets/userguide/mavenMigration/basic/groovy",files="build.gradle[tags=repositories]"]
include::sample[dir="snippets/userguide/mavenMigration/basic/kotlin",files="build.gradle.kts[tags=repositories]"]
====
...
====
include::sample[dir="snippets/userguide/mavenMigration/importBom/groovy",files="build.gradle[tags=bom]"]
include::sample[dir="snippets/userguide/mavenMigration/importBom/kotlin",files="build.gradle.kts[tags=bom]"]
====
...
====
include::sample[dir="snippets/userguide/mavenMigration/multiModule/groovy",files="settings.gradle"]
include::sample[dir="snippets/userguide/mavenMigration/multiModule/kotlin",files="settings.gradle.kts"]
====
...
----
> gradle projects
include::{snippetsPath}/userguide/mavenMigration/multiModule/projects.out[]
----
...
====
include::sample[dir="snippets/userguide/mavenMigration/profiles/groovy",files="build.gradle;profile-default.gradle;profile-test.gradle;profile-prod.gradle"]
include::sample[dir="snippets/userguide/mavenMigration/profiles/kotlin",files="build.gradle.kts;profile-default.gradle.kts;profile-test.gradle.kts;profile-prod.gradle.kts"]
====
...
----
> gradle greeting
include::{snippetsPath}/userguide/mavenMigration/profiles/greeting-default.out[]
----
.Output of **`gradle -PbuildProfile=test greeting`**
----
> gradle -PbuildProfile=test greeting
include::{snippetsPath}/userguide/mavenMigration/profiles/greeting-test.out[]
----
...
====
include::sample[dir="snippets/userguide/mavenMigration/basic/groovy",files="build.gradle[tags=process-resources]"]
include::sample[dir="snippets/userguide/mavenMigration/basic/kotlin",files="build.gradle.kts[tags=process-resources]"]
====
...
====
include::sample[dir="snippets/userguide/mavenMigration/basic/groovy",files="build.gradle[tags=checkstyle]"]
include::sample[dir="snippets/userguide/mavenMigration/basic/kotlin",files="build.gradle.kts[tags=checkstyle]"]
====
...
====
include::sample[dir="snippets/userguide/mavenMigration/basic/groovy",files="build.gradle[tags=depends-on]"]
include::sample[dir="snippets/userguide/mavenMigration/basic/kotlin",files="build.gradle.kts[tags=depends-on]"]
====
...
.Invoking Ant tasks
====
include::sample[dir="snippets/userguide/mavenMigration/ant/groovy",files="build.gradle"]
include::sample[dir="snippets/userguide/mavenMigration/ant/kotlin",files="build.gradle.kts"]
====
