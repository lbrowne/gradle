...
----
> gradle -q hello
include::{snippetsPath}/userguide/customPlugins/customPlugin/customPlugin.out[]
----
...
----
> gradle -q hello
include::{snippetsPath}/userguide/customPlugins/customPluginWithConvention/customPluginWithConvention.out[]
----
...
----
> gradle -q hello
include::{snippetsPath}/userguide/customPlugins/customPluginWithAdvancedConvention/customPluginWithAdvancedConvention.out[]
----
...
include::{snippetsPath}/userguide/tasks/customTaskWithFileProperty/lazyFileProperties.out[]
----
...
====
include::sample[dir="snippets/userguide/plugins/precompiledScriptPlugins/inBuildSrc/groovy",files="buildSrc/build.gradle[tags=apply]"]
include::sample[dir="snippets/userguide/plugins/precompiledScriptPlugins/inBuildSrc/kotlin",files="buildSrc/build.gradle.kts[tags=apply]"]
====
...
====
include::sample[dir="snippets/userguide/plugins/precompiledScriptPlugins/inBuildSrc/groovy",files="buildSrc/src/main/groovy/java-library-convention.gradle[]"]
include::sample[dir="snippets/userguide/plugins/precompiledScriptPlugins/inBuildSrc/kotlin",files="buildSrc/src/main/kotlin/java-library-convention.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/userguide/plugins/precompiledScriptPlugins/inBuildSrc/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/plugins/precompiledScriptPlugins/inBuildSrc/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/userguide/plugins/precompiledScriptPlugins/externalPlugins/groovy",files="buildSrc/build.gradle[]"]
include::sample[dir="snippets/userguide/plugins/precompiledScriptPlugins/externalPlugins/kotlin",files="buildSrc/build.gradle.kts[]"]
====

It can then be applied in the precompiled script plugin.
====
include::sample[dir="snippets/userguide/plugins/precompiledScriptPlugins/externalPlugins/groovy",files="buildSrc/src/main/groovy/my-plugin.gradle[]"]
include::sample[dir="snippets/userguide/plugins/precompiledScriptPlugins/externalPlugins/kotlin",files="buildSrc/src/main/kotlin/my-plugin.gradle.kts[]"]
====
...
----
include::{snippetsPath}/customPlugin/groovy/plugin/src/test/java/org/gradle/GreetingPluginTest.java[tag=test-plugin]
----
...
----
include::{snippetsPath}/customPlugin/groovy/plugin/src/main/resources/META-INF/gradle-plugins/org.samples.greeting.properties[]
----
