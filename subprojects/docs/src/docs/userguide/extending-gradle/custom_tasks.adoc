...
----
> gradle -q hello
include::{snippetsPath}/userguide/tasks/customTask/customTaskWithAction.out[]
----
...
include::{snippetsPath}/userguide/tasks/customTaskWithProperty/customTaskWithProperty.out[]
----
...
include::{snippetsPath}/userguide/tasks/incrementalTask/incrementalTaskFirstRun.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/incrementalTask/incrementalTaskNoChange.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/incrementalTask/incrementalTaskUpdatedInputs.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/incrementalTask/incrementalTaskRemovedInput.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/incrementalTask/incrementalTaskRemovedOutput.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/incrementalTask/incrementalTaskChangedProperty.out[]
----
====
...
.UrlVerify.java
----
include::{snippetsPath}/userguide/tasks/commandLineOption/stringOption/groovy/buildSrc/src/main/java/UrlVerify.java[tag=custom-task-implementation]
----
...
include::{snippetsPath}/userguide/tasks/commandLineOption/stringOption/taskCommandLineOption.out[]
----
...
.UrlProcess.java
----
include::{snippetsPath}/userguide/tasks/commandLineOption/optionValues/groovy/buildSrc/src/main/java/UrlProcess.java[tag=custom-task-implementation]
----
...
include::{snippetsPath}/userguide/tasks/commandLineOption/optionValues/helpTaskOptions.out[]
----
