...
.Download.java
----
include::{snippetsPath}/userguide/plugins/mutableManagedProperty/java/buildSrc/src/main/java/Download.java[]
----
[source.multi-language-sample,kotlin]
.Download.kt
----
include::{snippetsPath}/userguide/plugins/mutableManagedProperty/kotlin/buildSrc/src/main/kotlin/Download.kt[]
----
[source.multi-language-sample,groovy]
.Download.groovy
----
include::{snippetsPath}/userguide/plugins/mutableManagedProperty/groovy/buildSrc/src/main/groovy/Download.groovy[]
----
====
...
.Download.java
----
include::{snippetsPath}/userguide/plugins/readOnlyManagedProperty/java/buildSrc/src/main/java/Download.java[]
----
[source.multi-language-sample,kotlin]
.Download.kt
----
include::{snippetsPath}/userguide/plugins/readOnlyManagedProperty/kotlin/buildSrc/src/main/kotlin/Download.kt[]
----
[source.multi-language-sample,groovy]
.Download.groovy
----
include::{snippetsPath}/userguide/plugins/readOnlyManagedProperty/groovy/buildSrc/src/main/groovy/Download.groovy[]
----
====
...
.Download.java
----
include::{snippetsPath}/userguide/plugins/readOnlyNestedProperty/java/buildSrc/src/main/java/Download.java[tags=download]
include::{snippetsPath}/userguide/plugins/readOnlyNestedProperty/java/buildSrc/src/main/java/Resource.java[tags=resource]
----
[source.multi-language-sample,kotlin]
.Download.kt
----
include::{snippetsPath}/userguide/plugins/readOnlyNestedProperty/kotlin/buildSrc/src/main/kotlin/Download.kt[tags=download]
----
[source.multi-language-sample,groovy]
.Download.groovy
----
include::{snippetsPath}/userguide/plugins/readOnlyNestedProperty/groovy/buildSrc/src/main/groovy/Download.groovy[tags=download]
----
====
...
.Download.java
----
include::{snippetsPath}/userguide/plugins/constructorServiceInjection/java/buildSrc/src/main/java/Download.java[]
----
[source.multi-language-sample,kotlin]
.Download.kt
----
include::{snippetsPath}/userguide/plugins/constructorServiceInjection/kotlin/buildSrc/src/main/kotlin/Download.kt[]
----
[source.multi-language-sample,groovy]
.Download.groovy
----
include::{snippetsPath}/userguide/plugins/constructorServiceInjection/groovy/buildSrc/src/main/groovy/Download.groovy[]
----
====
...
.Download.java
----
include::{snippetsPath}/userguide/plugins/propertyServiceInjection/java/buildSrc/src/main/java/Download.java[]
----
[source.multi-language-sample,kotlin]
.Download.kt
----
include::{snippetsPath}/userguide/plugins/propertyServiceInjection/kotlin/buildSrc/src/main/kotlin/Download.kt[]
----
[source.multi-language-sample,groovy]
.Download.groovy
----
include::{snippetsPath}/userguide/plugins/propertyServiceInjection/groovy/buildSrc/src/main/groovy/Download.groovy[]
----
====
...
----
include::{snippetsPath}/userguide/plugins/nestedObjects/java/buildSrc/src/main/java/DownloadExtension.java[]
include::{snippetsPath}/userguide/plugins/nestedObjects/java/buildSrc/src/main/java/Resource.java[tags=resource]
----
[source.multi-language-sample,kotlin]
.DownloadExtension.kt
----
include::{snippetsPath}/userguide/plugins/nestedObjects/kotlin/buildSrc/src/main/kotlin/DownloadExtension.kt[]
include::{snippetsPath}/userguide/plugins/nestedObjects/kotlin/buildSrc/src/main/kotlin/Resource.kt[tags=resource]
----
[source.multi-language-sample,groovy]
.DownloadExtension.groovy
----
include::{snippetsPath}/userguide/plugins/nestedObjects/groovy/buildSrc/src/main/groovy/DownloadExtension.groovy[]
include::{snippetsPath}/userguide/plugins/nestedObjects/groovy/buildSrc/src/main/groovy/Resource.groovy[tags=resource]
----
====
...
.DownloadExtension.java
----
include::{snippetsPath}/userguide/plugins/namedDomainObjectContainer/java/buildSrc/src/main/java/DownloadExtension.java[]
include::{snippetsPath}/userguide/plugins/namedDomainObjectContainer/java/buildSrc/src/main/java/Resource.java[tags=resource]
----
[source.multi-language-sample,kotlin]
.DownloadExtension.kt
----
include::{snippetsPath}/userguide/plugins/namedDomainObjectContainer/kotlin/buildSrc/src/main/kotlin/DownloadExtension.kt[]
include::{snippetsPath}/userguide/plugins/namedDomainObjectContainer/kotlin/buildSrc/src/main/kotlin/Resource.kt[tags=resource]
----
[source.multi-language-sample,groovy]
.DownloadExtension.groovy
----
include::{snippetsPath}/userguide/plugins/namedDomainObjectContainer/groovy/buildSrc/src/main/groovy/DownloadExtension.groovy[]
include::{snippetsPath}/userguide/plugins/namedDomainObjectContainer/groovy/buildSrc/src/main/groovy/Resource.groovy[tags=resource]
----
====
...
.build.gradle.kts
----
include::{snippetsPath}/userguide/plugins/namedDomainObjectContainer/kotlin/build.gradle.kts[]
----
[source.multi-language-sample,groovy]
.build.gradle
----
include::{snippetsPath}/userguide/plugins/namedDomainObjectContainer/groovy/build.gradle[]
----
====
