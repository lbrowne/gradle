...
.WebServer.java
----
include::{snippetsPath}/userguide/plugins/buildService/java/buildSrc/src/main/java/WebServer.java[]
----
[source.multi-language-sample,kotlin]
.WebServer.kt
----
include::{snippetsPath}/userguide/plugins/buildService/kotlin/buildSrc/src/main/kotlin/WebServer.kt[]
----
[source.multi-language-sample,groovy]
.WebServer.groovy
----
include::{snippetsPath}/userguide/plugins/buildService/groovy/buildSrc/src/main/groovy/WebServer.groovy[]
----
====
...
.Download.java
----
include::{snippetsPath}/userguide/plugins/buildService/java/buildSrc/src/main/java/Download.java[]
----
[source.multi-language-sample,kotlin]
.Download.kt
----
include::{snippetsPath}/userguide/plugins/buildService/kotlin/buildSrc/src/main/kotlin/Download.kt[]
----
[source.multi-language-sample,groovy]
.Download.groovy
----
include::{snippetsPath}/userguide/plugins/buildService/groovy/buildSrc/src/main/groovy/Download.groovy[]
----
====
...
.DownloadPlugin.java
----
include::{snippetsPath}/userguide/plugins/buildService/java/buildSrc/src/main/java/DownloadPlugin.java[]
----
[source.multi-language-sample,kotlin]
.DownloadPlugin.kt
----
include::{snippetsPath}/userguide/plugins/buildService/kotlin/buildSrc/src/main/kotlin/DownloadPlugin.kt[]
----
[source.multi-language-sample,groovy]
.DownloadPlugin.groovy
----
include::{snippetsPath}/userguide/plugins/buildService/groovy/buildSrc/src/main/groovy/DownloadPlugin.groovy[]
----
====
