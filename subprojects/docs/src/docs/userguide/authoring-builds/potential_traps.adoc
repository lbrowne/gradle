...
.scope.groovy
----
include::{snippetsPath}/userguide/tutorial/groovyScope/scope.groovy[]
----

.Output of `groovy scope.groovy`
----
> groovy scope.groovy
include::{snippetsPath}/userguide/tutorial/groovyScope/scope.out[]
----
...
----
> gradle -q compile
include::{snippetsPath}/userguide/tutorial/mkdirTrap/mkdirTrap.out[]
----
