...
----
> gradle -q hello
include::{snippetsPath}/userguide/tutorial/hello/hello.out[]
----
====
...
----
> gradle -q upper
include::{snippetsPath}/userguide/tutorial/upper/upper.out[]
----
====
...
----
> gradle -q count
include::{snippetsPath}/userguide/tutorial/count/count.out[]
----
====
...
----
> gradle -q intro
include::{snippetsPath}/userguide/tutorial/intro/intro.out[]
----
====
...
----
> gradle -q taskX
include::{snippetsPath}/userguide/tutorial/lazyDependsOn/lazyDependsOn.out[]
----
====
...
----
> gradle -q task1
include::{snippetsPath}/userguide/tutorial/dynamic/dynamic.out[]
----
====
...
----
> gradle -q task0
include::{snippetsPath}/userguide/tutorial/dynamicDepends/dynamicDepends.out[]
----
====
...
----
> gradle -q hello
include::{snippetsPath}/userguide/tutorial/helloEnhanced/helloEnhanced.out[]
----
====
...
----
> gradle -q hello
include::{snippetsPath}/userguide/tutorial/helloWithShortCut/helloWithShortCut.out[]
----
====
...
include::{snippetsPath}/userguide/tutorial/extraProperties/extraTaskProperties.out[]
----
====
...
----
> gradle -q loadfile
include::{snippetsPath}/userguide/tutorial/antLoadfile/antLoadfile.out[]
----
====
...
----
> gradle -q loadfile
include::{snippetsPath}/userguide/tutorial/antLoadfileWithMethod/antLoadfileWithMethod.out[]
----
====
...
----
> gradle -q
include::{snippetsPath}/userguide/tutorial/defaultTasks/defaultTasks.out[]
----
====
...
include::{snippetsPath}/userguide/tutorial/configByDag/configByDagNoRelease.out[]
----

.Output of `gradle -q release`
----
> gradle -q release
include::{snippetsPath}/userguide/tutorial/configByDag/configByDag.out[]
----
====
...
----
> gradle -q encode
include::{snippetsPath}/userguide/tutorial/externalDependency/externalBuildDependency.out[]
----
====
