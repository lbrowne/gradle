...
----
> gradle -q list
include::{snippetsPath}/userguide/files/fileCollections/fileCollectionsWithClosure.out[]
----
...
include::{snippetsPath}/userguide/files/fileCollections/fileCollectionsFiltering.out[]
----
...
----
> gradle -q myZip
include::{snippetsPath}/userguide/files/archiveNaming/archiveNaming.out[]
----
...
include::{snippetsPath}/userguide/files/archiveNaming/zipWithCustomName.out[]
----
...
----
> gradle -q echoNames
include::{snippetsPath}/userguide/files/archivesChangedBaseName/zipWithArchivesBaseName.out[]
----
