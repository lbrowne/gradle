...
====
include::sample[dir="snippets/userguide/buildlifecycle/basic/groovy",files="settings.gradle[];build.gradle[]"]
include::sample[dir="snippets/userguide/buildlifecycle/basic/kotlin",files="settings.gradle.kts[];build.gradle.kts[]"]
====
...
include::{snippetsPath}/userguide/buildlifecycle/basic/buildlifecycle.groovy.out[]
----
[source.multi-language-sample,kotlin]
----
> gradle test testBoth
include::{snippetsPath}/userguide/buildlifecycle/basic/buildlifecycle.kotlin.out[]
----
...
.Hierarchical layout
====
include::sample[dir="snippets/userguide/multiproject/standardLayouts/groovy",files="settings.gradle[tags=hierarchical-layout]"]
include::sample[dir="snippets/userguide/multiproject/standardLayouts/kotlin",files="settings.gradle.kts[tags=hierarchical-layout]"]
====
...
.Flat layout
====
include::sample[dir="snippets/userguide/multiproject/standardLayouts/groovy",files="settings.gradle[tags=flat-layout]"]
include::sample[dir="snippets/userguide/multiproject/standardLayouts/kotlin",files="settings.gradle.kts[tags=flat-layout]"]
====
...
====
include::sample[dir="snippets/userguide/multiproject/customLayout/groovy",files="settings.gradle[tags=lookup-project]"]
include::sample[dir="snippets/userguide/multiproject/customLayout/kotlin",files="settings.gradle.kts[tags=lookup-project]"]
====
...
====
include::sample[dir="snippets/userguide/multiproject/customLayout/groovy",files="settings.gradle[tags=change-project]"]
include::sample[dir="snippets/userguide/multiproject/customLayout/kotlin",files="settings.gradle.kts[tags=change-project]"]
====
...
====
include::sample[dir="snippets/userguide/buildlifecycle/projectEvaluateEvents/groovy",files="build.gradle[tags=after-evaluate];projectA.gradle[]"]
include::sample[dir="snippets/userguide/buildlifecycle/projectEvaluateEvents/kotlin",files="build.gradle.kts[tags=after-evaluate];projectA.gradle.kts[]"]
====

.Output of `gradle -q test`
----
> gradle -q test
include::{snippetsPath}/userguide/buildlifecycle/projectEvaluateEvents/projectEvaluateEvents.out[]
----
...
.Notifications
====
include::sample[dir="snippets/userguide/buildlifecycle/buildProjectEvaluateEvents/groovy",files="build.gradle[tags=evaluate-events]"]
include::sample[dir="snippets/userguide/buildlifecycle/buildProjectEvaluateEvents/kotlin",files="build.gradle.kts[tags=evaluate-events]"]
====
...
----
> gradle -q test
include::{snippetsPath}/userguide/buildlifecycle/buildProjectEvaluateEvents/buildProjectEvaluateEvents.groovy.out[]
----
[source.multi-language-sample,kotlin]
----
> gradle -q test
include::{snippetsPath}/userguide/buildlifecycle/buildProjectEvaluateEvents/buildProjectEvaluateEvents.kotlin.out[]
----
...
====
include::sample[dir="snippets/userguide/buildlifecycle/taskCreationEvents/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/buildlifecycle/taskCreationEvents/kotlin",files="build.gradle.kts[]"]
====

.Output of **`gradle -q a`**
----
> gradle -q a
include::{snippetsPath}/userguide/buildlifecycle/taskCreationEvents/taskCreationEvents.out[]
----
...
====
include::sample[dir="snippets/userguide/buildlifecycle/taskExecutionEvents/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/buildlifecycle/taskExecutionEvents/kotlin",files="build.gradle.kts[]"]
====
...
----
> gradle -q broken
include::{snippetsPath}/userguide/buildlifecycle/taskExecutionEvents/taskExecutionEvents.groovy.out[]
----
[source.multi-language-sample,kotlin]
----
> gradle -q broken
include::{snippetsPath}/userguide/buildlifecycle/taskExecutionEvents/taskExecutionEvents.kotlin.out[]
----
