...
----
> gradle hello
include::{snippetsPath}/userguide/ant/useAntTask/useAntTask.out[]
----
...
----
> gradle hello
include::{snippetsPath}/userguide/ant/taskWithNestedText/taskWithNestedText.out[]
----
...
----
> gradle hello
include::{snippetsPath}/userguide/ant/hello/antHello.out[]
----
...
----
> gradle intro
include::{snippetsPath}/userguide/ant/dependsOnAntTarget/dependsOnAntTarget.out[]
----
...
----
> gradle hello
include::{snippetsPath}/userguide/ant/addBehaviourToAntTarget/addBehaviourToAntTarget.out[]
----
...
----
> gradle hello
include::{snippetsPath}/userguide/ant/dependsOnTask/dependsOnTask.out[]
----
...
----
> gradle a-hello
include::{snippetsPath}/userguide/ant/renameTask/renameAntDelegate.out[]
----
...
----
> gradle hello
include::{snippetsPath}/userguide/ant/antLogging/antLogging.out[]
----
