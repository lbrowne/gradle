...
----
> gradle -q hello
include::{snippetsPath}/userguide/tasks/accessUsingPath/accessUsingPath.out[]
----
====
...
----
> gradle -q taskX
include::{snippetsPath}/userguide/tasks/addDependencyUsingPath/addDependencyUsingPath.out[]
----
====
...
----
> gradle -q taskX
include::{snippetsPath}/userguide/tasks/addDependencyUsingTask/addDependencyUsingTask.out[]
----
====
...
----
> gradle -q taskX
include::{snippetsPath}/userguide/tasks/addDependencyUsingClosure/addDependencyUsingClosure.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/mustRunAfter/mustRunAfter.out[]
----
====
...
----
> gradle -q taskY taskX
include::{snippetsPath}/userguide/tasks/shouldRunAfter/shouldRunAfter.out[]
----
====
...
----
> gradle -q taskY
include::{snippetsPath}/userguide/tasks/mustRunAfter/mustRunAfterSingleTask.out[]
----
====
...
----
> gradle -q taskX
include::{snippetsPath}/userguide/tasks/shouldRunAfterWithCycle/shouldRunAfterWithCycle.out[]
----
====
...
include::{snippetsPath}/userguide/tutorial/taskOnlyIf/taskOnlyIf.out[]
----
====
...
----
> gradle -q myTask
include::{snippetsPath}/userguide/tutorial/stopExecutionException/stopExecutionException.out[]
----
====
...
----
> gradle disableMe
include::{snippetsPath}/userguide/tutorial/disableTask/disableTask.out[]
----
====
...
----
include::{snippetsPath}/userguide/tasks/incrementalBuild/customTaskClass/groovy/buildSrc/src/main/java/org/example/ProcessTemplates.java[tag=custom-task-class]
----

[source,java]
.buildSrc/src/main/java/org/example/TemplateData.java
----
include::{snippetsPath}/userguide/tasks/incrementalBuild/customTaskClass/groovy/buildSrc/src/main/java/org/example/TemplateData.java[]
----

.Output of `gradle processTemplates`
----
> gradle processTemplates
include::{snippetsPath}/userguide/tasks/incrementalBuild/customTaskClass/customTaskClassWithInputOutputAnnotations.out[]
----

.Output of `gradle processTemplates` (run again)
----
> gradle processTemplates
include::{snippetsPath}/userguide/tasks/incrementalBuild/customTaskClass/customTaskClassWithInputOutputAnnotationsUpToDate.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/incrementalBuild/customTaskClass/customTaskClassWithoutInputOutputAnnotations.out[]
----
...
include::{snippetsPath}/userguide/tasks/incrementalBuild/customTaskClass/incrementalAdHocTask.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/incrementalBuild/customTaskClass/incrementalAdHocTaskNoSource.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/incrementalBuild/customTaskClass/inferredTaskDep.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/incrementalBuild/customTaskClass/inferredTaskDep2.out[]
----
====
...
[source,java]
----
include::{snippetsPath}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy/buildSrc/src/main/java/org/example/ProcessTemplates.java[tag=custom-task-class]
----

.Output of `gradle processTemplates`
----
> gradle processTemplates
include::{snippetsPath}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildCustomMethods.out[]
----
====
...
[source,java]
----
include::{snippetsPath}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy/buildSrc/src/main/java/org/example/ProcessTemplates.java[tag=task-arg-method]
----

.Output of `gradle processTemplates2`
----
> gradle processTemplates2
include::{snippetsPath}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildCustomMethodsWithTaskArg.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildBadInputFilesConfig.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildInputFilesConfig.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildInputFilesConfigUsingTask.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/inferredTaskDependencyWithBuiltBy.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildUpToDateWhen.out[]
----

.Output of `gradle alwaysInstrumentClasses`
----
> gradle alwaysInstrumentClasses
include::{snippetsPath}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildUpToDateWhenAgain.out[]
----
====
...
include::{snippetsPath}/userguide/tasks/addRules/taskRule.out[]
----
====
...
----
> gradle -q groupPing
include::{snippetsPath}/userguide/tasks/addRules/taskRuleDependsOn.out[]
----
====
...
----
> gradle -q taskX
include::{snippetsPath}/userguide/tasks/finalizers/taskFinalizers.out[]
----
====
...
----
> gradle -q taskX
include::{snippetsPath}/userguide/tasks/finalizersWithFailure/taskFinalizersWithFailureGroovy.out[]
----
====
