...
----
> gradle -q hello
include::{snippetsPath}/userguide/multiproject/firstExample/water/multiprojectFirstExample.out[]
----
====
...
----
> gradle -q hello
include::{snippetsPath}/userguide/multiproject/addKrill/water/multiprojectAddKrill.out[]
----
====
...
----
> gradle -q hello
include::{snippetsPath}/userguide/multiproject/useSubprojects/water/multiprojectUseSubprojects.out[]
----
====
...
----
> gradle -q hello
include::{snippetsPath}/userguide/multiproject/subprojectsAddFromTop/water/multiprojectSubprojectsAddFromTop.out[]
----
====
...
----
> gradle -q hello
include::{snippetsPath}/userguide/multiproject/spreadSpecifics/water/multiprojectSpreadSpecifics.out[]
----
====
...
----
> gradle -q hello
include::{snippetsPath}/userguide/multiproject/addTropical/water/multiprojectAddTropical.out[]
----
====
...
----
> gradle -q hello
include::{snippetsPath}/userguide/multiproject/tropicalWithProperties/water/multiprojectTropicalWithProperties.out[]
----
====
...
----
> gradle -q hello
include::{snippetsPath}/userguide/multiproject/tropicalWithProperties/water/multiprojectSubBuild.out[]
----
...
include::{snippetsPath}/userguide/multiproject/partialTasks/water/multiprojectPartialTasks.out[]
----
...
include::{snippetsPath}/userguide/multiproject/partialTasks/water/multiprojectPartialTasksNotQuiet.out[]
----
====
...
include::{snippetsPath}/userguide/multiproject/tropicalWithProperties/water/multiprojectAbsoluteTaskPaths.out[]
----
...
----
> gradle -q action
include::{snippetsPath}/userguide/multiproject/dependencies/firstMessages/messages/multiprojectFirstMessages.out[]
----
====
...
----
> gradle -q action
include::{snippetsPath}/userguide/multiproject/dependencies/messagesHack/messages/multiprojectMessagesHack.out[]
----
...
----
> gradle -q action
include::{snippetsPath}/userguide/multiproject/dependencies/messagesHack/messages/multiprojectMessagesHackBroken.out[]
----
====
...
----
> gradle :api:build
include::{snippetsPath}/userguide/multiproject/dependencies/java/multitestingBuild.out[]
----
=====
====
...
include::{snippetsPath}/userguide/multiproject/dependencies/java/multitestingBuildNeeded.out[]
----
=====
====
...
include::{snippetsPath}/userguide/multiproject/dependencies/java/multitestingBuildDependents.out[]
----
=====
====
