...
----
> gradle -q check
include::{snippetsPath}/userguide/tutorial/projectApi/projectApi.out[]
----
====
...
include::{snippetsPath}/userguide/tutorial/extraProperties/extraProperties.out[]
----
====
...
----
> gradle -q configure
include::{snippetsPath}/userguide/tutorial/configureObject/configureObject.out[]
----
====
...
----
> gradle -q configure
include::{snippetsPath}/userguide/tutorial/configureObjectUsingScript/configureObjectUsingScript.out[]
----
====
