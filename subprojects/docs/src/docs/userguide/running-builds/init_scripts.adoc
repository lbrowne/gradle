...
include::{snippetsPath}/userguide/initScripts/configurationInjection/initScriptConfiguration.out[]
----
...
include::{snippetsPath}/userguide/initScripts/externalDependency/externalInitDependency.out[]
----
[source.multi-language-sample,kotlin]
----
...
include::{snippetsPath}/userguide/initScripts/plugins/usePluginsInInitScripts.out[]
----
[source.multi-language-sample,kotlin]
----
