...
include::{snippetsPath}/userguide/tutorial/properties/properties.out[]
----
...
include::{snippetsPath}/userguide/tutorial/configureTaskUsingProjectProperty/configureTaskUsingProjectProperty.out[]
----
