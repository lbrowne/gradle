...
----
$ gradle -q list
include::{snippetsPath}/userguide/artifacts/generatedFileDependencies/generatedFileDependencies.out[]
----
...
include::{snippetsPath}/userguide/dependencyManagement/inspectingDependencies/dependencyReason/dependencyReasonReport.out[]
----
