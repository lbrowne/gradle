...
include::{snippetsPath}/userguide/dependencyManagement/inspectingDependencies/dependenciesReport/dependencyReport.out[]
----
...
include::{snippetsPath}/userguide/dependencyManagement/inspectingDependencies/dependencyInsightReport/dependencyInsightReport.out[]
----
