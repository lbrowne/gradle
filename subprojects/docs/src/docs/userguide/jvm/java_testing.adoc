...
----
> gradle -q showDirs
include::{snippetsPath}/userguide/java/customDirs/javaCustomReportDirs.out[]
----
...
----
include::{snippetsPath}/userguide/java/fixtures/groovy/lib/src/main/java/com/acme/Person.java[tags=sample]
----
...
----
include::{snippetsPath}/userguide/java/fixtures/groovy/lib/src/testFixtures/java/com/acme/Simpsons.java[tags=sample]
----
...
include::{snippetsPath}/userguide/java/fixtures/dependencyInsight.out[]
----
