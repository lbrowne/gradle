...
public class DefaultProjectDescriptorRegistryTest {
    ...
    private final DefaultScriptFileResolver resolver = new DefaultScriptFileResolver();

    @Test
    public void addProjectDescriptor() {
        DefaultProjectDescriptor rootProject = new DefaultProjectDescriptor(null, "testName", TEST_DIR, registry, FILE_RESOLVER, resolver);
    ...
    public void changeProjectDescriptorPath() {
        DefaultProjectDescriptor project = new DefaultProjectDescriptor(null, "name", TEST_DIR, registry, FILE_RESOLVER, resolver);
